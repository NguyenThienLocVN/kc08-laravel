    ...
    <header>
        <div class="container">
            ...
            <ul class="text-banner-tablet">
                ...
                <div><input type="text" name="search-banner-table" id="search-banner-table" class="search-banner-table" placeholder="Nội dung tìm kiếm ..."><i class="fa fa-search" aria-hidden="true"></i></div>
            </ul>
