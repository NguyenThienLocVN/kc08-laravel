...
<!-- cho mũi tên bên phải <i class="fa fa-caret-right" aria-hidden="true"></i> -->
    ...
    <li><a href="#" class="item-link">SỔ TAY HƯỚNG DẪN QUẢN LÝ BỜ SÔNG </a><i class="fa fa-caret-down" aria-hidden="true"></i>
        <ul class="submenu">
            <li><a href="#">Phần 1: Hướng dẫn chung</a><i class="fa fa-caret-right" aria-hidden="true"></i>
            <li><a href="#">Phần 2: Hướng dẫn xác định hành lang BVBS</a><i class="fa fa-caret-right" aria-hidden="true"></i>   
            <li><a href="#">Phần 3: Hướng dẫn quản lý sử dụng hành lang BVBS</a><i class="fa fa-caret-right" aria-hidden="true"></i>
            <li><a href="#">Phần 4: Phạm vi hành lang bảo vệ </a><i class="fa fa-caret-right" aria-hidden="true"></i>
            <li><a href="#">Phần 5: Phân cấp kỹ thuật đường thủy nội địa</a><i class="fa fa-caret-right" aria-hidden="true"></i>
            </li>
            <li><a href="#">Hiện trạng khai thác, sử dụng đất ven sông</a></li>
        </ul>
    </li>
