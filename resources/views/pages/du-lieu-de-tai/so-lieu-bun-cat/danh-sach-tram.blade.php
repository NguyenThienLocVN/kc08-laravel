...
<div class="content list-station">
    ...
    <table>
        <tr class="row-station">
            ...
            <td class="item" style="text-align: center;">Thời kỳ đo</td>
            <td></td>
        </tr>
        @foreach( $stations as $st )          
            <tr class="row-station">
                ...
                <td><a href="#" onclick="openMuddySand({{ $st->Station_ID }})" title="Xem chi tiết"><i class="fa fa-file-text-o" aria-hidden="true"></i></a></td>
            </tr>
        @endforeach
