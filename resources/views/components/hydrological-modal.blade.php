...
<div class="modal fade" id="hydrologicalModal" tabindex="-1" role="dialog" aria-labelledby="hydrologicalModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div id="overlay"></div>
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold" id="hydrologicalModalLabel"></h5>
